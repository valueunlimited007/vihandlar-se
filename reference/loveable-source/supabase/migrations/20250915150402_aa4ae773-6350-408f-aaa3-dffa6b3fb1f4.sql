-- Add missing E-additives from Livsmedelsverket - Phase 1: Most common and important ones
...
('E110', 'Solnedgångsgul FCF', 'Sunset Yellow', 'e110-solnedgangsgul', 'Färgämne', 'Syntetisk', 7, 'Negativ', 'Gult-orange syntetiskt färgämne som kan orsaka hyperaktivitet', 'Solnedgångsgul FCF är ett syntetiskt färgämne som används för att ge livsmedel en gul-orange färg. Studier visar att det kan orsaka hyperaktivitet hos barn och allergiska reaktioner. Kräver varningstext på förpackningar i EU.', 'E110 Solnedgångsgul - Hyperaktivitet hos barn | Vihandlar.se', 'E110 Solnedgångsgul FCF kan orsaka hyperaktivitet hos barn. Läs om biverkningar, var det finns och säkrare alternativ.'),
...
('E220', 'Svaveldioxid', 'Sulfur Dioxide', 'e220-svaveldioxid', 'Konserveringsmedel', 'Syntetisk', 6, 'Negativ', 'Konserveringsmedel som kan orsaka astmaanfall', 'Svaveldioxid används som konserveringsmedel och antioxidant, särskilt i vin och torkad frukt. Det kan orsaka svåra astmaanfall hos känsliga personer och måste deklareras på etiketten vid halter över 10 mg/kg.', 'E220 Svaveldioxid - Astmarisk i vin och frukt | Vihandlar.se', 'E220 Svaveldioxid kan utlösa astmaanfall. Läs om detta konserveringsmedel i vin och torkad frukt.'),
...
-- Add ADI values for relevant additives
...
-- Add health effects and common products for key additives
UPDATE public.e_additives SET 
  health_effects = '{"documented": ["Hyperaktivitet hos barn", "Allergiska reaktioner"], "suspected": ["Påverkar koncentration"], "risk_groups": ["Barn", "Astmatiker"]}',
  common_products = '[{"category": "Godis", "products": ["Gott & Blandat", "Skittles"], "average_amount": "10-50mg per portion"}, {"category": "Läsk", "products": ["Fanta", "Sprite"], "average_amount": "15-25mg per 33cl"}]',
  avoidance_tips = '["Välj naturligt färgade produkter", "Läs ingrediensförteckningen noga", "Undvik produkter märkta som innehåller E110"]'
WHERE e_number = 'E110';
...
UPDATE public.e_additives SET 
  health_effects = '{"documented": ["Astmaanfall", "Allergiska reaktioner"], "suspected": ["Huvudvärk"], "risk_groups": ["Astmatiker", "Sulfitallergiker"]}',
  common_products = '[{"category": "Vin", "products": ["Vitt vin", "Rött vin"], "average_amount": "50-200mg per liter"}, {"category": "Torkad frukt", "products": ["Russin", "Aprikoser"], "average_amount": "500-2000mg per kg"}]'
WHERE e_number = 'E220';