-- Rensa befintliga listor och items först
...
BEGIN
  INSERT INTO public_lists (slug, title, description, lang, is_public) 
  VALUES ('frukost-vecka', 'Frukost-veckan', 'Allt du behöver för en veckas varierad och näringsrik frukost', 'sv-SE', true)
...
BEGIN
  INSERT INTO public_lists (slug, title, description, lang, is_public) 
  VALUES ('lchf-vecka', 'LCHF-veckan', 'Komplett inköpslista för en veckas lågkolhydratskost', 'sv-SE', true)
...
BEGIN
  INSERT INTO public_lists (slug, title, description, lang, is_public) 
  VALUES ('vegetarisk-vecka', 'Vegetarisk Vecka', 'Proteinrik vegetarisk kost för hela veckan', 'sv-SE', true)
...
BEGIN
  INSERT INTO public_lists (slug, title, description, lang, is_public) 
  VALUES ('barnfamilj-vecka', 'Barnfamilj Veckohandling', 'Barnvänlig veckohandling med näring och gott humör', 'sv-SE', true)
...
BEGIN
  INSERT INTO public_lists (slug, title, description, lang, is_public) 
  VALUES ('student-budget', 'Studentbudget', 'Prisvärd veckohandling perfekt för studenter', 'sv-SE', true)
...
BEGIN
  INSERT INTO public_lists (slug, title, description, lang, is_public) 
  VALUES ('fredagsmys', 'Fredagsmys', 'Allt för en mysig fredagskväll hemma', 'sv-SE', true)
...
BEGIN
  INSERT INTO public_lists (slug, title, description, lang, is_public) 
  VALUES ('fest-10-personer', 'Fest för 10 Personer', 'Komplett lista för en lyckad festkväll', 'sv-SE', true)
...
BEGIN
  INSERT INTO public_lists (slug, title, description, lang, is_public) 
  VALUES ('matlada-vecka', 'Matlådeveckan', 'Smart meal prep för hela arbetsveckan', 'sv-SE', true)
...
BEGIN
  INSERT INTO public_lists (slug, title, description, lang, is_public) 
  VALUES ('halsosam-start', 'Hälsosam Start', 'Smoothies, sallader och hälsosamma mellanmål', 'sv-SE', true)
...
BEGIN
  INSERT INTO public_lists (slug, title, description, lang, is_public) 
  VALUES ('vardagsmiddagar', 'Vardagsmiddagar', 'Fem enkla och snabba middagsrätter', 'sv-SE', true)
